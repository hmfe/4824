...
class SearchForm extends Component {
  ...
  removeResultListItem(searchInput) {
    ...
    updatedResultList = updatedResultList.filter(
      ...
      <article>
        ...
        <section>
          <form id="searchForm" onSubmit={this.handleSubmit}>
            ...
            {this.state.filteredList.length > 0 && (
              <SuggestionsList
                ...
                onClick={item => this.updateResultList(item)}
              />
            )}
          </form>
          ...
          <header>
            ...
            <button
              className="button__clear-list"
              onClick={this.clearResultList}
            >
          ...
          <ul>
            {this.state.resultList.map((item, index) => (
              <ListItem
                ...
                date={item.date}
                onClick={e => this.removeResultListItem(item.searchInput)}
              />
            ))}
          </ul>
        </section>
